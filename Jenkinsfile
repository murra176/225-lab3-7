pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/murra176'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/murra176/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('murra176-255-sp26')                                                         //<------your MiamiID
    }
